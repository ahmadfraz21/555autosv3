...
.nlinks a,.nlinks button{font-family:var(--font);font-size:.9rem;color:var(--blk);text-decoration:none;padding:8px 14px;border-radius:8px;border:none;background:transparent;cursor:pointer;transition:var(--tr);white-space:nowrap}
...
.hcon{position:relative;z-index:10;text-align:center;padding:20px}
.h555{font-family:'Arial Black',sans-serif;font-size:clamp(100px,20vw,220px);font-weight:900;color:white;line-height:.85;text-shadow:0 0 80px rgba(204,0,0,.8),0 0 160px rgba(204,0,0,.4);animation:hIn 1s ease .5s both;letter-spacing:-5px}
.h555 span{color:var(--red)}
...
.bp{padding:14px 32px;background:var(--red);color:white;border:none;border-radius:12px;font-family:var(--font);font-size:1.1rem;cursor:pointer;transition:var(--tr);box-shadow:0 4px 20px rgba(204,0,0,.4)}.bp:hover{background:var(--rd);transform:translateY(-3px)}
.bg{padding:14px 32px;background:rgba(255,255,255,.15);color:white;border:1px solid rgba(255,255,255,.3);border-radius:12px;font-family:var(--font);font-size:1.1rem;cursor:pointer;backdrop-filter:var(--blur);transition:var(--tr)}.bg:hover{background:rgba(255,255,255,.25);transform:translateY(-3px)}
